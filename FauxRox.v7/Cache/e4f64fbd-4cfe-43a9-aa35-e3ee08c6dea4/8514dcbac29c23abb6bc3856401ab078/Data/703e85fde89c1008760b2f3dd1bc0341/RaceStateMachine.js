...
let RaceStateMachine = (() => {
    ...
    var RaceStateMachine = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.finishSplitsContainer = this.finishSplitsContainer;
            /** Prefab for split entry (Text component) */
            this.finishSplitPrefab = this.finishSplitPrefab;
        ...
        addFinishSplitEntry(text, yPos, isIncomplete) {
            if (!this.finishSplitPrefab || !this.finishSplitsContainer)
                return;
            ...
            // Set text
            var textComp = entry.getComponent('Component.Text');
            if (textComp) {
                textComp.text = text;
