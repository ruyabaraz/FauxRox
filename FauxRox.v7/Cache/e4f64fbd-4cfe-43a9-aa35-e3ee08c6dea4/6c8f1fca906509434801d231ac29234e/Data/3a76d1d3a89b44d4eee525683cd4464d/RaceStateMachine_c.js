...
// @input AssignableType_3 runArrowGuide
// @input AssignableType_4 cloudManager
// @input AssignableType_5 aiCoach
// @input AssignableType_6 profileManager
// @input AssignableType_7 onboardingUI
...
// @input SceneObject hrConnectedIcon
...
// @input Asset.ObjectPrefab repPopupPrefab
// @input SceneObject finishPanel
// @input Component.Text finishStatusText
// @input Component.Text finishTotalTimeText
// @input SceneObject finishPBBadge
// @input Component.Text finishPBText
// @input Component.Text finishAvgHRText
// @input Component.Text finishPeakHRText
// @input Component.Text finishFastestText
// @input Component.Text finishNeedsWorkText
// @input Component.ScriptComponent finishRaceAgainButton
// @input Component.ScriptComponent finishViewSplitsButton
// @input Component.ScriptComponent finishResetButton
// @input SceneObject splitsPanel
// @input Component.Text splitsStatusText
// @input Component.Text splitsTimeText
// @input Component.Text splitsListText
// @input Component.ScriptComponent splitsRaceAgainButton
// @input Component.ScriptComponent splitsGoBackButton
