...
let RaceStateMachine = (() => {
    ...
    var RaceStateMachine = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.REP_POPUP_POP_DURATION = 0.15; // Quick pop in
            this.REP_POPUP_FLOAT_DURATION = 0.6; // Float up and fade
            this.REP_POPUP_TOTAL_DURATION = 0.75; // Total animation time
            this.REP_POPUP_FLOAT_DISTANCE = 30; // cm to float up
