...
export class RaceStateMachine extends BaseScriptComponent {
  ...
  private readonly REP_POPUP_POP_DURATION: number = 0.15;   // Quick pop in
  private readonly REP_POPUP_FLOAT_DURATION: number = 0.6;  // Float up and fade
  private readonly REP_POPUP_TOTAL_DURATION: number = 0.75; // Total animation time
  private readonly REP_POPUP_FLOAT_DISTANCE: number = 30;   // cm to float up
