...
let RaceStateMachine = (() => {
    ...
    var RaceStateMachine = _classThis = class extends _classSuper {
        ...
        getPlayerForward() {
            ...
            // Use same method as CourseSetup: rotation * vec3.forward()
            // This ensures consistent forward direction calculation
            ...
            print('[RaceStateMachine] getPlayerForward: rot*forward=(' + forward.x.toFixed(2) + ', ' + forward.y.toFixed(2) + ', ' + forward.z.toFixed(2) + '), flat=(' + flatForward.x.toFixed(2) + ', ' + flatForward.z.toFixed(2) + ')');
            return flatForward;
        }
        // ── Helpers ────────────────────────────────────────────────────────────────
