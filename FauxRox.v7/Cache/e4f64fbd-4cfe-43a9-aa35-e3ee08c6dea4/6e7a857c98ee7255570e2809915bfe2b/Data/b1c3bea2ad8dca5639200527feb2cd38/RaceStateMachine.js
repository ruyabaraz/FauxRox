...
let RaceStateMachine = (() => {
    ...
    var RaceStateMachine = _classThis = class extends _classSuper {
        ...
        onBLEFlowComplete() {
            print('[RaceStateMachine] BLE flow complete');
            // Enable UI elements
            ...
            // Check if already calibrated (coming from Race Again / reset)
            var setup = this.setup();
            if (setup && setup.isCalibrated) {
                // Already calibrated - just enable start button directly
                print('[RaceStateMachine] Already calibrated — enabling start button');
            ...
            print('[RaceStateMachine] Starting floor calibration');
        ...
        resetRace() {
            ...
            // Start button will be enabled AFTER onboarding completes
            if (this.needsOnboarding()) {
                ...
                // No onboarding needed - enable start button immediately
                if (this.startButtonObject) {
                    this.startButtonObject.enabled = true;
                }
                if (this.instructionText) {
