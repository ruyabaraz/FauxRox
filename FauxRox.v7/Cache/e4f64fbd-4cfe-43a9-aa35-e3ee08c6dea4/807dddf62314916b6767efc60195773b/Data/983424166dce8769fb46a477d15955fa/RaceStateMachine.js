...
let RaceStateMachine = (() => {
    ...
    var RaceStateMachine = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.countdownBeepSound = this.countdownBeepSound; // Plays on 3, 2, 1
            this.countdownGoSound = this.countdownGoSound; // Plays on GO!
            /** Screen flash overlay for GO! effect */
            this.screenFlashImage = this.screenFlashImage;
            ...
            this.COUNTDOWN_ZOOM_DURATION = 0.25;
            this.COUNTDOWN_ZOOM_SCALE = 1.8;
            // Screen flash for GO!
            this._screenFlashing = false;
            this._screenFlashTime = 0;
            this.SCREEN_FLASH_DURATION = 0.3;
        }
        __initialize() {
            super.__initialize();
            // ── References ────────────────────────────────────────────────────────────
        ...
        updateScreenFlash(dt) {
            if (!this._screenFlashing || !this.screenFlashImage)
                return;
