...
let RaceStateMachine = (() => {
    ...
    var RaceStateMachine = _classThis = class extends _classSuper {
        ...
        togglePause() {
            if (this._state === RaceState.RUNNING || this._state === RaceState.STATION || this._state === RaceState.APPROACHING_STATION) {
                ...
                if (this._pausedFromState === RaceState.RUNNING) {
                    ...
                    if (this.statusText) {
                        this.statusText.text = this._currentConfig.mode === CourseManager_1.StationMode.DISTANCE ? 'Cross station line' : 'Enter station';
                    }
                }
        ...
        spawnStationAndApproach() {
            ...
            // Set up gate plane for crossing detection
