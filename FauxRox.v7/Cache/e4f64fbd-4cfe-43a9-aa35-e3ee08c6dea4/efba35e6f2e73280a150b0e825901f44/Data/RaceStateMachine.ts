...
// courseManager and proximityDetector typed as ScriptComponent
// to avoid compile-order TS2304 errors.
// ============================================================================
...
export class RaceStateMachine extends BaseScriptComponent {
  ...
  /** Drag RaceController SceneObject here (self-reference for ProximityDetector) */
  @input proximityDetectorScript: Component.ScriptComponent;
  ...
  // Split tracking (parallel arrays)
