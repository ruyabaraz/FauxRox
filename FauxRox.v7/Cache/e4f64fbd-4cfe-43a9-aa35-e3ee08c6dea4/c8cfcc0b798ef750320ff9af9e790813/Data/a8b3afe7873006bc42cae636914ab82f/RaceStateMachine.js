...
let RaceStateMachine = (() => {
    ...
    var RaceStateMachine = _classThis = class extends _classSuper {
        ...
        getPlayerForward() {
            ...
            // Use same method as GroundCalibration - pitch-independent horizontal forward
            // camera.right × up = horizontal forward direction regardless of camera tilt
            var forward = this.camTransform.right.cross(vec3.up()).normalize();
