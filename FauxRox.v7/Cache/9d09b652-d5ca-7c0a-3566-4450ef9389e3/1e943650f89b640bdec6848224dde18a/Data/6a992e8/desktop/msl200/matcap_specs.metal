...
//sampler sampler matcapTexSmpSC 0:24
//sampler sampler normalTexSmpSC 0:25
...
//texture texture2D matcapTex 0:5:0:24
//texture texture2D normalTex 0:6:0:25
...
//float matcapIntensity 4384
//float3x3 matcapTexTransform 4448
//float4 matcapTexUvMinMax 4496
//float4 matcapTexBorderColor 4512
//float3x3 normalTexTransform 4576
//float4 normalTexUvMinMax 4624
//float4 normalTexBorderColor 4640
//float Port_Import_N072 4660
//float3 Port_Input2_N016 4672
//float Port_Input2_N023 4704
//float depthRef 4708
//}
...
//spec_const bool matcapTexHasSwappedViews 44 0
//spec_const bool normalTexHasSwappedViews 45 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_matcapTex 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_matcapTex 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 82 -1
//spec_const int intensityTextureLayout 83 0
//spec_const int matcapTexLayout 84 0
//spec_const int normalTexLayout 85 0
...
constant bool ENABLE_MATCAP [[function_constant(30)]];
constant bool ENABLE_MATCAP_tmp = is_function_constant_defined(ENABLE_MATCAP) ? ENABLE_MATCAP : false;
constant bool ENABLE_NORMAL [[function_constant(31)]];
constant bool ENABLE_NORMAL_tmp = is_function_constant_defined(ENABLE_NORMAL) ? ENABLE_NORMAL : false;
...
constant bool SC_USE_CLAMP_TO_BORDER_matcapTex [[function_constant(34)]];
...
constant bool SC_USE_UV_MIN_MAX_matcapTex [[function_constant(37)]];
...
constant bool SC_USE_UV_TRANSFORM_matcapTex [[function_constant(40)]];
...
constant bool matcapTexHasSwappedViews [[function_constant(44)]];
...
constant bool normalTexHasSwappedViews [[function_constant(45)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_matcapTex [[function_constant(78)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_normalTex [[function_constant(79)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_matcapTex [[function_constant(81)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_normalTex [[function_constant(82)]];
...
constant int matcapTexLayout [[function_constant(84)]];
constant int matcapTexLayout_tmp = is_function_constant_defined(matcapTexLayout) ? matcapTexLayout : 0;
constant int normalTexLayout [[function_constant(85)]];
...
float Port_Import_N070;
float Port_Import_N072;
float3 Port_Input2_N016;
float3 Port_Import_N074;
...
texture2d<float> matcapTex [[id(5)]];
...
sampler matcapTexSmpSC [[id(24)]];
sampler normalTexSmpSC [[id(25)]];
...
{
main_frag_out out={};
bool N75_LockRollRotationToWorld=false;
int N75_NormalSpace=0;
float3 N75_Normal=float3(0.0);
float2 N75_ReflectionUV=float2(0.0);
...
float param_2=(*sc_set0.UserUniforms).Port_Input2_N023;
ssGlobals param_4=Globals;
float4 param_3;
if ((int(ENABLE_MATCAP_tmp)!=0))
{
float l9_1=0.0;
float l9_2=(*sc_set0.UserUniforms).matcapIntensity;
l9_1=l9_2;
float l9_3=0.0;
l9_3=l9_1;
float l9_4=0.0;
l9_4=fast::clamp((*sc_set0.UserUniforms).Port_Import_N072,0.0,1.0);
float l9_5=0.0;
l9_5=1.0;
float3 l9_6=float3(0.0);
float3 l9_7=float3(1.0);
float3 l9_8=(*sc_set0.UserUniforms).Port_Input2_N016;
ssGlobals l9_9=param_4;
float3 l9_10;
if ((int(ENABLE_NORMAL_tmp)!=0))
{
float4 l9_11=float4(0.0);
ssGlobals l9_12=l9_9;
int l9_13;
...
int l9_18=l9_13;
int l9_19=normalTexLayout_tmp;
int l9_20=l9_18;
float2 l9_21=l9_12.Surface_UVCoord0;
bool l9_22=(int(SC_USE_UV_TRANSFORM_normalTex_tmp)!=0);
float3x3 l9_23=(*sc_set0.UserUniforms).normalTexTransform;
int2 l9_24=int2(SC_SOFTWARE_WRAP_MODE_U_normalTex_tmp,SC_SOFTWARE_WRAP_MODE_V_normalTex_tmp);
bool l9_25=(int(SC_USE_UV_MIN_MAX_normalTex_tmp)!=0);
float4 l9_26=(*sc_set0.UserUniforms).normalTexUvMinMax;
bool l9_27=(int(SC_USE_CLAMP_TO_BORDER_normalTex_tmp)!=0);
float4 l9_28=(*sc_set0.UserUniforms).normalTexBorderColor;
float l9_29=0.0;
...
float3 l9_94=l9_93;
float3 l9_95=l9_94;
float4 l9_96=sc_set0.normalTex.sample(sc_set0.normalTexSmpSC,l9_95.xy,bias(l9_89));
float4 l9_97=l9_96;
if (l9_27)
{
...
float4 l9_98=l9_97;
float4 l9_99=l9_98;
float3 l9_100=(l9_99.xyz*1.9921875)-float3(1.0);
l9_99=float4(l9_100.x,l9_100.y,l9_100.z,l9_99.w);
l9_11=l9_99;
l9_7=l9_11.xyz;
l9_10=l9_7;
}
...
float l9_103=l9_4;
float l9_104=l9_5;
float3 l9_105=l9_101;
ssGlobals l9_106=param_4;
ssGlobals tempGlobals=l9_106;
float2 l9_107=float2(0.0);
N75_LockRollRotationToWorld=l9_103!=0.0;
N75_NormalSpace=int(l9_104);
N75_Normal=l9_105;
float3 l9_108=N75_Normal;
if (N75_NormalSpace==1)
{
float3 l9_109=tempGlobals.VertexTangent_WorldSpace;
float3 l9_110=tempGlobals.VertexBinormal_WorldSpace;
float3 l9_111=tempGlobals.VertexNormal_WorldSpace;
float3x3 l9_112=float3x3(float3(l9_109),float3(l9_110),float3(l9_111));
l9_108=normalize(l9_112*l9_108);
}
float3 l9_113=tempGlobals.ViewDirWS;
float3 l9_114=normalize(-l9_113);
int l9_115=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_115=0;
...
int l9_116=l9_115;
float3 l9_117=(*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_116][1].xyz;
float3 l9_118=l9_117;
if (N75_LockRollRotationToWorld)
{
int l9_119=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_120=l9_119;
float4x4 l9_121=(*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_120];
l9_118=float3x3(l9_121[0].xyz,l9_121[1].xyz,l9_121[2].xyz)*l9_118;
}
float3 l9_122=normalize(cross(l9_114,l9_118));
float3 l9_123=cross(l9_122,l9_114);
float3x3 l9_124=float3x3(float3(l9_122.x,l9_123.x,l9_114.x),float3(l9_122.y,l9_123.y,l9_114.y),float3(l9_122.z,l9_123.z,l9_114.z));
l9_108=l9_124*l9_108;
N75_ReflectionUV=(l9_108.xy*0.5)+float2(0.5);
l9_107=N75_ReflectionUV;
l9_102=l9_107;
...
int l9_131=l9_126;
int l9_132=matcapTexLayout_tmp;
int l9_133=l9_131;
float2 l9_134=l9_102;
bool l9_135=(int(SC_USE_UV_TRANSFORM_matcapTex_tmp)!=0);
float3x3 l9_136=(*sc_set0.UserUniforms).matcapTexTransform;
int2 l9_137=int2(SC_SOFTWARE_WRAP_MODE_U_matcapTex_tmp,SC_SOFTWARE_WRAP_MODE_V_matcapTex_tmp);
bool l9_138=(int(SC_USE_UV_MIN_MAX_matcapTex_tmp)!=0);
float4 l9_139=(*sc_set0.UserUniforms).matcapTexUvMinMax;
bool l9_140=(int(SC_USE_CLAMP_TO_BORDER_matcapTex_tmp)!=0);
float4 l9_141=(*sc_set0.UserUniforms).matcapTexBorderColor;
float l9_142=0.0;
...
float4 l9_209=sc_set0.matcapTex.sample(sc_set0.matcapTexSmpSC,l9_208.xy,bias(l9_202));
...
float2 l9_215=floor(mod(l9_214.xy,float2(4.0)));
float l9_216=(mod(dot(l9_215,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_5<l9_216)
{
discard_fragment();
}
...
float4 l9_217=fast::max(param_6,float4(0.0));
float4 param_7=l9_217;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_220=fast::clamp(l9_219.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_220=fast::clamp(dot(l9_219.xyz,float3(l9_219.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_220=(1.0-dot(l9_219.xyz,float3(0.33333001)))*l9_219.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_220=(1.0-fast::clamp(dot(l9_219.xyz,float3(1.0)),0.0,1.0))*l9_219.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_220=fast::clamp(dot(l9_219.xyz,float3(1.0)),0.0,1.0)*l9_219.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_220=fast::clamp(dot(l9_219.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_220=dot(l9_219.xyz,float3(0.33333001))*l9_219.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_220=1.0-fast::clamp(dot(l9_219.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_221=l9_220;
float l9_222=l9_221;
float l9_223=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_222;
float3 l9_224=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_218.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_225=float4(l9_224.x,l9_224.y,l9_224.z,l9_223);
param_8=l9_225;
}
else
{
...
{
float4 l9_226=param_8;
float4 l9_227=float4(0.0);
float4 l9_228=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_229=out.sc_FragData0;
l9_228=l9_229;
}
else
{
float4 l9_230=gl_FragCoord;
float2 l9_231=l9_230.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_236=l9_235;
int l9_237=l9_236;
float3 l9_238=float3(l9_232,0.0);
int l9_239=l9_234;
int l9_240=l9_237;
if (l9_239==1)
{
l9_238.y=((2.0*l9_238.y)+float(l9_240))-1.0;
}
float2 l9_241=l9_238.xy;
l9_233=l9_241;
}
else
{
...
int l9_254=sc_ScreenTextureLayout_tmp;
int l9_255=l9_252;
float l9_256=l9_246;
...
float4 l9_263=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_262.xy,bias(l9_256));
float4 l9_264=l9_263;
float4 l9_265=l9_264;
l9_228=l9_265;
}
float4 l9_266=l9_228;
float3 l9_267=l9_266.xyz;
float3 l9_268=l9_267;
float3 l9_269=l9_226.xyz;
float3 l9_270=definedBlend(l9_268,l9_269,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_227=float4(l9_270.x,l9_270.y,l9_270.z,l9_227.w);
float3 l9_271=mix(l9_267,l9_227.xyz,float3(l9_226.w));
l9_227=float4(l9_271.x,l9_271.y,l9_271.z,l9_227.w);
l9_227.w=1.0;
float4 l9_272=l9_227;
param_8=l9_272;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_273=float4(in.varScreenPos.xyz,1.0);
param_8=l9_273;
}
else
{
...
float l9_275=fast::clamp(abs(l9_274.z),0.0,1.0);
float4 l9_276=float4(l9_275,1.0-l9_275,1.0,1.0);
param_8=l9_276;
}
else
{
float4 l9_277=param_8;
float4 l9_278=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_278=float4(mix(float3(1.0),l9_277.xyz,float3(l9_277.w)),l9_277.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_279=l9_277.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_279=fast::clamp(l9_279,0.0,1.0);
}
l9_278=float4(l9_277.xyz*l9_279,l9_279);
}
else
{
l9_278=l9_277;
...
float4 l9_284=param_10;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_284.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_284;
return out;
}
} // FRAGMENT SHADER
