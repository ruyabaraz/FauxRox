...
let LocationTracker = (() => {
    ...
    var LocationTracker = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.lastGpsUpdateTime = 0; // When GPS last gave us a position update
            // GPS Status
         ...
         * @param onDistanceUpdate Called with (totalDistance, deltaDistance) in meters
         */
        resumeTracking(onDistanceUpdate) {
            if (this.isTracking) {
                this.log('Already tracking');
                return;
            }
         ...
         */
        isGpsActivelyUpdating(maxAgeSeconds = 3.0) {
