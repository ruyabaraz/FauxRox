...
{
float4 l9_249=out.sc_FragData0;
l9_248=l9_249;
}
else
{
float4 l9_250=gl_FragCoord;
float2 l9_251=l9_250.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_256=l9_255;
int l9_257=l9_256;
float3 l9_258=float3(l9_252,0.0);
int l9_259=l9_254;
int l9_260=l9_257;
if (l9_259==1)
{
l9_258.y=((2.0*l9_258.y)+float(l9_260))-1.0;
}
float2 l9_261=l9_258.xy;
l9_253=l9_261;
}
else
{
...
int l9_272=l9_267;
float2 l9_273=l9_265;
int l9_274=sc_ScreenTextureLayout_tmp;
int l9_275=l9_272;
float l9_276=l9_266;
...
float4 l9_283=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_282.xy,bias(l9_276));
float4 l9_284=l9_283;
float4 l9_285=l9_284;
l9_248=l9_285;
}
float4 l9_286=l9_248;
float3 l9_287=l9_286.xyz;
float3 l9_288=l9_287;
float3 l9_289=l9_246.xyz;
float3 l9_290=definedBlend(l9_288,l9_289,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_247=float4(l9_290.x,l9_290.y,l9_290.z,l9_247.w);
float3 l9_291=mix(l9_287,l9_247.xyz,float3(l9_246.w));
l9_247=float4(l9_291.x,l9_291.y,l9_291.z,l9_247.w);
l9_247.w=1.0;
float4 l9_292=l9_247;
param_74=l9_292;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_293=float4(in.varScreenPos.xyz,1.0);
param_74=l9_293;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_294=gl_FragCoord;
float l9_295=fast::clamp(abs(l9_294.z),0.0,1.0);
float4 l9_296=float4(l9_295,1.0-l9_295,1.0,1.0);
param_74=l9_296;
}
else
{
float4 l9_297=param_74;
float4 l9_298=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_298=float4(mix(float3(1.0),l9_297.xyz,float3(l9_297.w)),l9_297.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_299=l9_297.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_299=fast::clamp(l9_299,0.0,1.0);
}
l9_298=float4(l9_297.xyz*l9_299,l9_299);
}
else
{
l9_298=l9_297;
...
FinalColor=sc_OutputMotionVectorIfNeeded(param_75,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_76=FinalColor;
float4 l9_304=param_76;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_304.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_304;
return out;
}
} // FRAGMENT SHADER
