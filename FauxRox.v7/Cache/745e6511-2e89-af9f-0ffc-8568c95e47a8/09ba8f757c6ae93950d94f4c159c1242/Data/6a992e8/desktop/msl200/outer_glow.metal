...
//texture texture2D opacityTex 0:3:0:20
...
//}
//ubo int UserUniforms 0:28:4720 {
//float4 sc_Time 1376
...
//float glowDistance 4256
//float4 baseColor 4272
//float3x3 baseTexTransform 4336
//float4 baseTexUvMinMax 4384
//float4 baseTexBorderColor 4400
//float2 baseScale 4416
//float2 Tweak_N41 4424
//float Tweak_N38 4432
//float glowFalloff 4436
//float3x3 opacityTexTransform 4496
//float4 opacityTexUvMinMax 4544
//float4 opacityTexBorderColor 4560
//float2 opacityScale 4576
//float2 Tweak_N52 4584
//float Tweak_N53 4592
//float2 Port_Center_N026 4632
//float4 Port_Default_N040 4656
//float2 Port_Center_N008 4696
//float Port_Default_N204 4712
//}
...
//spec_const bool ENABLE_ANIMATED_BASE 30 0
//spec_const bool ENABLE_ANIMATED 31 0
//spec_const bool ENABLE_OPACITY_TEX 32 0
//spec_const bool ENABLE_STIPPLE_PATTERN_TEST 33 0
...
constant bool ENABLE_ANIMATED_BASE [[function_constant(30)]];
constant bool ENABLE_ANIMATED_BASE_tmp = is_function_constant_defined(ENABLE_ANIMATED_BASE) ? ENABLE_ANIMATED_BASE : false;
constant bool ENABLE_ANIMATED [[function_constant(31)]];
constant bool ENABLE_ANIMATED_tmp = is_function_constant_defined(ENABLE_ANIMATED) ? ENABLE_ANIMATED : false;
...
constant bool ENABLE_STIPPLE_PATTERN_TEST [[function_constant(33)]];
constant bool ENABLE_STIPPLE_PATTERN_TEST_tmp = is_function_constant_defined(ENABLE_STIPPLE_PATTERN_TEST) ? ENABLE_STIPPLE_PATTERN_TEST : false;
constant bool SC_USE_CLAMP_TO_BORDER_baseTex [[function_constant(34)]];
...
constant bool SC_USE_CLAMP_TO_BORDER_opacityTex [[function_constant(36)]];
...
constant bool SC_USE_UV_MIN_MAX_baseTex [[function_constant(37)]];
...
constant bool SC_USE_UV_MIN_MAX_opacityTex [[function_constant(39)]];
...
constant bool Tweak_N0 [[function_constant(43)]];
constant bool Tweak_N0_tmp = is_function_constant_defined(Tweak_N0) ? Tweak_N0 : false;
...
constant int SC_SOFTWARE_WRAP_MODE_V_opacityTex [[function_constant(84)]];
...
constant int Tweak_N48 [[function_constant(85)]];
constant int Tweak_N48_tmp = is_function_constant_defined(Tweak_N48) ? Tweak_N48 : 0;
constant int baseTexLayout [[function_constant(86)]];
constant int baseTexLayout_tmp = is_function_constant_defined(baseTexLayout) ? baseTexLayout : 0;
constant int intensityTextureLayout [[function_constant(87)]];
constant int intensityTextureLayout_tmp = is_function_constant_defined(intensityTextureLayout) ? intensityTextureLayout : 0;
constant int opacityTexLayout [[function_constant(88)]];
...
constant int sc_RenderingSpace [[function_constant(90)]];
constant int sc_RenderingSpace_tmp = is_function_constant_defined(sc_RenderingSpace) ? sc_RenderingSpace : -1;
constant int sc_ScreenTextureLayout [[function_constant(91)]];
constant int sc_ScreenTextureLayout_tmp = is_function_constant_defined(sc_ScreenTextureLayout) ? sc_ScreenTextureLayout : 0;
constant int sc_ShaderCacheConstant [[function_constant(92)]];
constant int sc_ShaderCacheConstant_tmp = is_function_constant_defined(sc_ShaderCacheConstant) ? sc_ShaderCacheConstant : 0;
constant int sc_SkinBonesCount [[function_constant(93)]];
constant int sc_SkinBonesCount_tmp = is_function_constant_defined(sc_SkinBonesCount) ? sc_SkinBonesCount : 0;
constant int sc_StereoRenderingMode [[function_constant(94)]];
constant int sc_StereoRenderingMode_tmp = is_function_constant_defined(sc_StereoRenderingMode) ? sc_StereoRenderingMode : 0;
constant int sc_StereoRendering_IsClipDistanceEnabled [[function_constant(95)]];
...
float2 Tweak_N52;
float Tweak_N53;
float4 Port_Import_N030;
float Port_Import_N031;
float2 Port_Center_N026;
float2 Port_Import_N037;
float4 Port_Default_N040;
float4 Port_Import_N166;
float Port_Import_N206;
float2 Port_Center_N008;
float2 Port_Import_N057;
...
float Interpolator_gInstanceRatio [[user(locn13)]];
...
float3 Normal_N10=float3(0.0);
Normal_N10=Globals.VertexNormal_WorldSpace;
float3 Output_N15=float3(0.0);
float3 param_1=Normal_N10;
float l9_124=dot(param_1,param_1);
float l9_125;
if (l9_124>0.0)
{
...
float l9_126=l9_125;
float3 param_2=param_1*l9_126;
Output_N15=param_2;
float Output_N6=0.0;
float param_3=(*sc_set0.UserUniforms).glowDistance;
Output_N6=param_3;
float InstanceRatio_N9=0.0;
float l9_127;
if ((*sc_set0.UserUniforms).sc_GeometryInfo.y>1.0)
{
l9_127=float(ssInstanceID)/((*sc_set0.UserUniforms).sc_GeometryInfo.y-1.0);
}
else
{
l9_127=0.0;
}
InstanceRatio_N9=l9_127;
float Output_N7=0.0;
Output_N7=Output_N6*InstanceRatio_N9;
float3 Output_N3=float3(0.0);
Output_N3=Output_N15*float3(Output_N7);
float3 Position_N0=float3(0.0);
Position_N0=Globals.SurfacePosition_WorldSpace;
float3 Output_N137=float3(0.0);
Output_N137=Output_N3+Position_N0;
WorldPosition=Output_N137;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
...
float3 param_5=WorldPosition;
float3 param_6=WorldNormal;
float3 param_7=WorldTangent;
float4 param_8=v.position;
out.varPosAndMotion=float4(param_5.x,param_5.y,param_5.z,out.varPosAndMotion.w);
float3 l9_128=normalize(param_6);
out.varNormalAndMotion=float4(l9_128.x,l9_128.y,l9_128.z,out.varNormalAndMotion.w);
float3 l9_129=normalize(param_7);
out.varTangent=float4(l9_129.x,l9_129.y,l9_129.z,out.varTangent.w);
out.varTangent.w=in.tangent.w;
if ((int(UseViewSpaceDepthVariant_tmp)!=0)&&(((int(sc_OITDepthGatherPass_tmp)!=0)||(int(sc_OITCompositingPass_tmp)!=0))||(int(sc_OITDepthBoundsPass_tmp)!=0)))
{
float4 l9_130=param_4.position;
...
int l9_141=l9_140;
l9_139=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_141]*param_4.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
out.varTex01=float4(param_4.texture0,param_4.texture1);
if ((int(sc_ProjectiveShadowsReceiver_tmp)!=0))
{
float4 l9_146=param_4.position;
...
float3 param_9=out.varPosAndMotion.xyz;
if ((int(sc_MotionVectorsPass_tmp)!=0))
{
float4 l9_455=((*sc_set0.UserUniforms).sc_PrevFrameModelMatrix*(*sc_set0.UserUniforms).sc_ModelMatrixInverse)*float4(param_9,1.0);
float3 l9_456=param_9;
...
{
main_frag_out out={};
float4 N59_GlowColor=float4(0.0);
float N59_GlowFalloff=0.0;
float3 N59_SurfacePosition=float3(0.0);
float4 N59_OutputColor=float4(0.0);
...
Value_N30=Output_N24;
float4 Result_N40=float4(0.0);
float4 param_1=float4(0.0);
float4 param_2=(*sc_set0.UserUniforms).Port_Default_N040;
ssGlobals param_4=Globals;
float4 param_3;
if ((int(Tweak_N0_tmp)!=0))
{
float2 l9_0=float2(0.0);
float2 l9_1=float2(1.0);
float2 l9_2=float2(0.0);
ssGlobals l9_3=param_4;
float2 l9_4;
if ((int(ENABLE_ANIMATED_BASE_tmp)!=0))
{
...
float2 l9_15=(*sc_set0.UserUniforms).baseScale;
l9_14=l9_15;
float2 l9_16=float2(0.0);
l9_16=((l9_5-(*sc_set0.UserUniforms).Port_Center_N026)*l9_14)+(*sc_set0.UserUniforms).Port_Center_N026;
float2 l9_17=float2(0.0);
float2 l9_18=(*sc_set0.UserUniforms).Tweak_N41;
l9_17=l9_18;
float l9_19=0.0;
float l9_20=(*sc_set0.UserUniforms).Tweak_N38;
l9_19=l9_20;
float2 l9_21=float2(0.0);
l9_21=l9_16+(l9_17*(l9_3.gTimeElapsed*l9_19));
l9_1=l9_21;
l9_4=l9_1;
}
else
...
ssGlobals l9_26=l9_3;
float2 l9_27;
if (NODE_44_DROPLIST_ITEM_tmp==0)
{
float2 l9_28=float2(0.0);
l9_28=l9_26.Surface_UVCoord0;
l9_23=l9_28;
l9_27=l9_23;
}
else
...
float2 l9_32=(*sc_set0.UserUniforms).baseScale;
l9_31=l9_32;
float2 l9_33=float2(0.0);
l9_33=((l9_22-(*sc_set0.UserUniforms).Port_Center_N026)*l9_31)+(*sc_set0.UserUniforms).Port_Center_N026;
l9_2=l9_33;
l9_4=l9_2;
}
l9_0=l9_4;
...
int l9_41=l9_36;
int l9_42=baseTexLayout_tmp;
int l9_43=l9_41;
float2 l9_44=l9_34;
bool l9_45=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 l9_46=(*sc_set0.UserUniforms).baseTexTransform;
int2 l9_47=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool l9_48=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 l9_49=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool l9_50=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 l9_51=(*sc_set0.UserUniforms).baseTexBorderColor;
float l9_52=0.0;
...
Output_N45=Value_N30*Result_N40;
float4 Export_N46=float4(0.0);
Export_N46=Output_N45;
float Output_N62=0.0;
float param_5=(*sc_set0.UserUniforms).glowFalloff;
Output_N62=param_5;
float InstanceRatio_N71=0.0;
InstanceRatio_N71=Globals.gInstanceRatio;
float Output_N79=0.0;
Output_N79=Output_N62*InstanceRatio_N71;
float3 Position_N68=float3(0.0);
Position_N68=Globals.SurfacePosition_ObjectSpace;
float4 OutputColor_N59=float4(0.0);
float4 param_6=Export_N46;
float param_7=Output_N79;
float3 param_8=Position_N68;
ssGlobals param_10=Globals;
ssGlobals tempGlobals=param_10;
float4 param_9=float4(0.0);
N59_GlowColor=param_6;
N59_GlowFalloff=param_7;
N59_SurfacePosition=param_8;
float3 l9_122=tempGlobals.SurfacePosition_ObjectSpace;
float3 l9_123=l9_122;
float l9_124=1.0;
float l9_125=N59_GlowFalloff;
float l9_126=distance(l9_123,N59_SurfacePosition);
float l9_127=1.0-smoothstep(l9_124-l9_125,l9_124,l9_126);
N59_OutputColor=float4(N59_GlowColor.xyz*l9_127,N59_GlowColor.w*l9_127);
param_9=N59_OutputColor;
OutputColor_N59=param_9;
float Value1_N126=0.0;
float Value2_N126=0.0;
float Value3_N126=0.0;
float4 param_11=OutputColor_N59;
float param_12=param_11.x;
float param_13=param_11.y;
float param_14=param_11.z;
Value1_N126=param_12;
Value2_N126=param_13;
Value3_N126=param_14;
float4 Value_N166=float4(0.0);
Value_N166=Export_N46;
float Output_N168=0.0;
Output_N168=Value_N166.w;
float Result_N204=0.0;
float param_15=0.0;
float param_16=(*sc_set0.UserUniforms).Port_Default_N204;
ssGlobals param_18=Globals;
float param_17;
if ((int(ENABLE_OPACITY_TEX_tmp)!=0))
{
float2 l9_128=float2(0.0);
float2 l9_129=float2(1.0);
float2 l9_130=float2(0.0);
ssGlobals l9_131=param_18;
float2 l9_132;
if ((int(ENABLE_ANIMATED_tmp)!=0))
{
float2 l9_133=float2(0.0);
float2 l9_134=float2(0.0);
float2 l9_135=float2(0.0);
float2 l9_136=float2(0.0);
ssGlobals l9_137=l9_131;
float2 l9_138;
if (Tweak_N48_tmp==0)
{
...
l9_141=l9_137.Surface_UVCoord0;
l9_136=l9_141;
l9_138=l9_136;
}
}
...
float2 l9_143=(*sc_set0.UserUniforms).opacityScale;
l9_142=l9_143;
float2 l9_144=float2(0.0);
l9_144=((l9_133-(*sc_set0.UserUniforms).Port_Center_N008)*l9_142)+(*sc_set0.UserUniforms).Port_Center_N008;
float2 l9_145=float2(0.0);
float2 l9_146=(*sc_set0.UserUniforms).Tweak_N52;
l9_145=l9_146;
float l9_147=0.0;
float l9_148=(*sc_set0.UserUniforms).Tweak_N53;
l9_147=l9_148;
float2 l9_149=float2(0.0);
l9_149=l9_144+(l9_145*(l9_131.gTimeElapsed*l9_147));
l9_129=l9_149;
l9_132=l9_129;
}
else
...
l9_158=l9_154.Surface_UVCoord0;
l9_153=l9_158;
l9_155=l9_153;
}
}
...
float2 l9_160=(*sc_set0.UserUniforms).opacityScale;
l9_159=l9_160;
float2 l9_161=float2(0.0);
l9_161=((l9_150-(*sc_set0.UserUniforms).Port_Center_N008)*l9_159)+(*sc_set0.UserUniforms).Port_Center_N008;
l9_130=l9_161;
l9_132=l9_130;
}
l9_128=l9_132;
...
float4 l9_247=sc_set0.opacityTex.sample(sc_set0.opacityTexSmpSC,l9_246.xy,bias(l9_240));
float4 l9_248=l9_247;
if (l9_178)
{
l9_248=mix(l9_179,l9_248,float4(l9_182));
}
...
Value_N127.x=Value1_N126;
Value_N127.y=Value2_N126;
Value_N127.z=Value3_N126;
Value_N127.w=Export_N158;
...
float2 l9_252=floor(mod(l9_251.xy,float2(4.0)));
float l9_253=(mod(dot(l9_252,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_19<l9_253)
{
discard_fragment();
}
...
{
l9_256=fast::clamp(l9_255.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_256=fast::clamp(dot(l9_255.xyz,float3(l9_255.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_256=(1.0-dot(l9_255.xyz,float3(0.33333001)))*l9_255.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_256=(1.0-fast::clamp(dot(l9_255.xyz,float3(1.0)),0.0,1.0))*l9_255.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_256=fast::clamp(dot(l9_255.xyz,float3(1.0)),0.0,1.0)*l9_255.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_256=fast::clamp(dot(l9_255.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_256=dot(l9_255.xyz,float3(0.33333001))*l9_255.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_256=1.0-fast::clamp(dot(l9_255.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_257=l9_256;
float l9_258=l9_257;
float l9_259=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_258;
float3 l9_260=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_254.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_261=float4(l9_260.x,l9_260.y,l9_260.z,l9_259);
param_20=l9_261;
}
else
{
...
{
float4 l9_262=param_20;
float4 l9_263=float4(0.0);
float4 l9_264=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_265=out.sc_FragData0;
l9_264=l9_265;
}
else
{
float4 l9_266=gl_FragCoord;
float2 l9_267=l9_266.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_272=l9_271;
int l9_273=l9_272;
float3 l9_274=float3(l9_268,0.0);
int l9_275=l9_270;
int l9_276=l9_273;
if (l9_275==1)
{
l9_274.y=((2.0*l9_274.y)+float(l9_276))-1.0;
}
float2 l9_277=l9_274.xy;
l9_269=l9_277;
}
else
{
...
int l9_288=l9_283;
float2 l9_289=l9_281;
int l9_290=sc_ScreenTextureLayout_tmp;
int l9_291=l9_288;
float l9_292=l9_282;
...
float4 l9_299=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_298.xy,bias(l9_292));
float4 l9_300=l9_299;
float4 l9_301=l9_300;
l9_264=l9_301;
}
float4 l9_302=l9_264;
float3 l9_303=l9_302.xyz;
float3 l9_304=l9_303;
float3 l9_305=l9_262.xyz;
float3 l9_306=definedBlend(l9_304,l9_305,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_263=float4(l9_306.x,l9_306.y,l9_306.z,l9_263.w);
float3 l9_307=mix(l9_303,l9_263.xyz,float3(l9_262.w));
l9_263=float4(l9_307.x,l9_307.y,l9_307.z,l9_263.w);
l9_263.w=1.0;
float4 l9_308=l9_263;
param_20=l9_308;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_309=float4(in.varScreenPos.xyz,1.0);
param_20=l9_309;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_310=gl_FragCoord;
float l9_311=fast::clamp(abs(l9_310.z),0.0,1.0);
float4 l9_312=float4(l9_311,1.0-l9_311,1.0,1.0);
param_20=l9_312;
}
else
{
float4 l9_313=param_20;
float4 l9_314=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_314=float4(mix(float3(1.0),l9_313.xyz,float3(l9_313.w)),l9_313.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_315=l9_313.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_315=fast::clamp(l9_315,0.0,1.0);
}
l9_314=float4(l9_313.xyz*l9_315,l9_315);
}
else
{
l9_314=l9_313;
...
FinalColor=sc_OutputMotionVectorIfNeeded(param_21,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_22=FinalColor;
float4 l9_320=param_22;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_320.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_320;
return out;
}
} // FRAGMENT SHADER
