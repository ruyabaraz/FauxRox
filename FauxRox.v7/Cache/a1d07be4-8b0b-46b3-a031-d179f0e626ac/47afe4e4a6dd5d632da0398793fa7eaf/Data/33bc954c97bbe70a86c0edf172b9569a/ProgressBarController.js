    ...
    var ProgressBarController = _classThis = class extends _classSuper {
        ...
        applyProgress(progress) {
            ...
            if (this.useScreenTransform && this.fillScreenTransform && this.fillOriginalAnchors) {
                // IMAGE mode: adjust right anchor directly
                ...
                // Set anchors directly
                this.fillScreenTransform.anchors.left = left;
                this.fillScreenTransform.anchors.right = newRight;
                this.fillScreenTransform.anchors.top = this.fillOriginalAnchors.top;
                this.fillScreenTransform.anchors.bottom = this.fillOriginalAnchors.bottom;
                // Debug log
