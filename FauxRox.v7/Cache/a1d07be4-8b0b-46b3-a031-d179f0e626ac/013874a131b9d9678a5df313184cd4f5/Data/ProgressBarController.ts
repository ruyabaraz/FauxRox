...
export class ProgressBarController extends BaseScriptComponent {
  ...
  private applyProgress(progress: number): void {
    ...
    if (this.useScreenTransform && this.fillScreenTransform && this.fillOriginalAnchors) {
      ...
      this.fillScreenTransform.anchors.setCenter(new vec2(
        (left + newRight) / 2,
        (this.fillOriginalAnchors.top + this.fillOriginalAnchors.bottom) / 2
      ));
      this.fillScreenTransform.anchors.setSize(new vec2(
        newRight - left,
        this.fillOriginalAnchors.top - this.fillOriginalAnchors.bottom
      ));
