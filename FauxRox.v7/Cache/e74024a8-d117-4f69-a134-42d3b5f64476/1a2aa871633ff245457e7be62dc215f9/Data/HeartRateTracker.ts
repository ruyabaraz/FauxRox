...
export class HeartRateTracker extends BaseScriptComponent {
  ...
  private bluetoothModule: Bluetooth.BluetoothCentralModule = null;
  ...
  private initBluetooth(): void {
    try {
      this.bluetoothModule = require("LensStudio:BluetoothCentralModule") as Bluetooth.BluetoothCentralModule;
  ...
  private onGattConnected(): void {
    ...
    this.bluetoothGatt.onConnectionStateChangedEvent.add((event: Bluetooth.ConnectionStateChangeEvent) => {
