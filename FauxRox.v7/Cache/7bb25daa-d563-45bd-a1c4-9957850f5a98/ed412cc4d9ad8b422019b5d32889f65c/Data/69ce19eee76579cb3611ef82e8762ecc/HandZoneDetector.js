    ...
    var HandZoneDetector = _classThis = class extends _classSuper {
        ...
        processHorizontalMotion(hands, camPos) {
            ...
            if (this._motionType === CourseManager_1.MotionType.BACKWARD_PULL) {
                // ROWING: Ready = arms extended forward, Hit = hands pulled back to body
                var extendedThreshold = 35; // Arms extended forward (35cm ahead)
                var pulledBackThreshold = 15; // Arms pulled back (15cm or less from body)
                var validHeight = avgY > -50 && avgY < 10; // Between chest and shoulder height
