...
exports.HandZoneDetector = exports.MotionType = exports.ZoneState = void 0;
...
// Motion direction for different exercises
var MotionType;
(function (MotionType) {
...
let HandZoneDetector = (() => {
    ...
    var HandZoneDetector = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.targetHeightOffset = this.targetHeightOffset;
            ...
            this._motionType = MotionType.OVERHEAD_REACH;
            this._repCount = 0;
         ...
         */
        startDetection(motionType, onRep, onStateChange) {
            ...
            this._isActive = true;
            this._cooldownTimer = 0;
            // Spawn target zone visual
            this.spawnTargetZone();
            this.log('Detection started: ' + motionType);
        }
        /**
         * Stop zone detection
         */
