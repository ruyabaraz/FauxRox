...
export class HandZoneDetector extends BaseScriptComponent {
  ...
  private processOverheadPull(hands: HandPositions, camPos: vec3): void {
    ...
    // HARDCODED thresholds - ignore inspector values which may be stale
    var readyThreshold = 10;   // Hands just 10cm above camera = READY
    var targetThreshold = -20; // Hands 20cm below camera = HIT
