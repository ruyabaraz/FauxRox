...
let CourseManager = (() => {
    ...
    var CourseManager = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.finishVfxPrefab = this.finishVfxPrefab;
            // ── Run Settings ────────────────────────────────────────────────────────
            ...
            this.burpeeReps = this.burpeeReps;
        ...
        spawnFinishVFX(position) {
            ...
            destroyEvent.reset(6.0);
        }
        /** Recursively disable particle emitters in hierarchy */
        disableParticleEmitters(obj) {
            // Try common particle component types
            var comp = obj.getComponent("Component.VFXComponent");
            if (comp) {
                comp.enabled = false;
        ...
        setObjectAlpha(obj, fadeProgress) {
