...
let CourseManager = (() => {
    ...
    var CourseManager = _classThis = class extends _classSuper {
        ...
        updateDirectionArrow(playerPos, targetStationIndex, cameraTransform) {
            ...
            // Note: Arrow prefab should have its "forward" pointing in +Z or use lookAt correctly
            // lookAt(direction, up) makes the object's -Z face the direction
            // If arrow model points +Z forward, we need to flip or adjust
            var rotation = quat.lookAt(dirToTarget, vec3.up());
