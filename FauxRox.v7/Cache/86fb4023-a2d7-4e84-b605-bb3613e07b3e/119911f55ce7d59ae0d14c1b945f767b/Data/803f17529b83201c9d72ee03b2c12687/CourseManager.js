...
//
// IMPORTANT: SurfacePlacement import path below must match your project.
// If Surface Detection is an unpacked package, path is typically:
//   '../SurfacePlacement/Scripts/SurfacePlacementController'
// If it's under Assets:
//   './SurfacePlacement/SurfacePlacementController'
// If it's a .lspkg package:
//   'SurfaceDetection.lspkg/Scripts/SurfacePlacementController'
//
// *** UPDATE THE TWO IMPORT LINES BELOW TO MATCH YOUR PROJECT STRUCTURE ***
//
// Attach to SceneObject "CourseRoot".
// ============================================================================
// ██ Import from SurfacePlacement package ██
const SurfacePlacementController_1 = require("SurfacePlacement.lspkg/Scripts/SurfacePlacementController");
const PlacementSettings_1 = require("SurfacePlacement.lspkg/Scripts/PlacementSettings");
let CourseManager = (() => {
    ...
    var CourseManager = _classThis = class extends _classSuper {
        ...
        startPlacement() {
            ...
            var settings = new PlacementSettings_1.PlacementSettings(PlacementSettings_1.PlacementMode.HORIZONTAL, false);
            SurfacePlacementController_1.SurfacePlacementController.getInstance().startSurfacePlacement(settings, (pos, rot) => {
