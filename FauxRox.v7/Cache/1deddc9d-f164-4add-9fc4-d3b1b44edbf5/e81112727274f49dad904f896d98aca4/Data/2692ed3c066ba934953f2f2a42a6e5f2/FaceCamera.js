...
let FaceCamera = (() => {
    ...
    var FaceCamera = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.followDistance = this.followDistance; // cm from camera
            this.followSpeed = this.followSpeed; // lerp speed
            this.verticalOffset = this.verticalOffset; // cm below eye level
            this.horizontalOffset = this.horizontalOffset; // cm to the left (negative = left)
            this.deadzoneDegrees = this.deadzoneDegrees; // don't move if within this angle
