...
float4 param_6=(*sc_set0.UserUniforms).Port_ringColor_N005;
float4 param_7=(*sc_set0.UserUniforms).Port_bgColor_N005;
ssGlobals param_8=Globals;
ssGlobals tempGlobals=param_8;
float4 param_3=float4(0.0);
N5_progress=param_4;
N5_ringWidth=param_5;
...
float4 l9_19=fast::max(param_10,float4(0.0));
float4 param_11=l9_19;
if (sc_ShaderCacheConstant_tmp!=0)
{
