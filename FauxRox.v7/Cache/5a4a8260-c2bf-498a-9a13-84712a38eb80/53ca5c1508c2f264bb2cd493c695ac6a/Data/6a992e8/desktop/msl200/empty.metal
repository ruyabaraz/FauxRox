...
//float progress 4384
//float4 ringColor 4400
//float2 Port_resolution_N005 4416
//float depthRef 4424
//}
...
float4 param_2=(*sc_set0.UserUniforms).ringColor;
Output_N2=param_2;
float4 fragColor_N5=float4(0.0);
float2 param_4=(*sc_set0.UserUniforms).Port_resolution_N005;
float param_5=Output_N0;
float4 param_6=Output_N2;
ssGlobals param_7=Globals;
ssGlobals tempGlobals=param_7;
float4 param_3=float4(0.0);
N5_resolution=param_4;
N5_progress=param_5;
N5_ringColor=param_6;
float2 l9_1=tempGlobals.Surface_UVCoord0;
float2 l9_2=l9_1-float2(0.5);
float l9_3=(l9_2.x*l9_2.x)+(l9_2.y*l9_2.y);
float l9_4=(1.0-smoothstep(0.15000001,0.153,l9_3))*smoothstep(0.050000001,0.052999999,l9_3);
float l9_5=(1.0-smoothstep(0.050000001,0.25,l9_3))*smoothstep(-0.050000001,0.15000001,l9_3);
float l9_6=l9_2.y;
float l9_7=l9_2.x;
float l9_8;
if (l9_6==0.0)
...
param_3=N5_fragColor;
fragColor_N5=param_3;
...
float4 l9_17=fast::max(param_9,float4(0.0));
float4 param_10=l9_17;
if (sc_ShaderCacheConstant_tmp!=0)
{
