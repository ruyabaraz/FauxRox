...
//float2 Port_resolution_N005 4384
//float Port_progress_N005 4392
//float4 Port_ringColor_N005 4400
//float depthRef 4416
//}
...
float2 Port_resolution_N005;
float Port_progress_N005;
float4 Port_ringColor_N005;
float depthRef;
};
struct sc_Bone_t
{
...
float3 N5_getResolution(thread float2& N5_resolution)
{
if (N5_resolution.x==0.0)
{
return float3(640.0,640.0,1.0);
}
return float3(N5_resolution,1.0);
}
...
{
main_frag_out out={};
float4 N5_fragColor=float4(0.0);
float2 N5_resolution=float2(0.0);
float N5_progress=0.0;
float4 N5_ringColor=float4(0.0);
...
float4 fragColor_N5=float4(0.0);
float2 param_2=(*sc_set0.UserUniforms).Port_resolution_N005;
float param_3=(*sc_set0.UserUniforms).Port_progress_N005;
float4 param_4=(*sc_set0.UserUniforms).Port_ringColor_N005;
ssGlobals param_5=Globals;
ssGlobals tempGlobals=param_5;
float4 param_1=float4(0.0);
N5_resolution=param_2;
N5_progress=param_3;
N5_ringColor=param_4;
float2 l9_1=tempGlobals.Surface_UVCoord0;
float2 l9_2=l9_1-float2(0.5);
float l9_3=(l9_2.x*l9_2.x)+(l9_2.y*l9_2.y);
float l9_4=(1.0-smoothstep(0.18000001,0.183,l9_3))*smoothstep(0.1,0.103,l9_3);
float l9_5=(1.0-smoothstep(0.1,0.28,l9_3))*smoothstep(0.0,0.18000001,l9_3);
float l9_6=l9_2.y;
float l9_7=l9_2.x;
float l9_8;
if (l9_6==0.0)
...
{
l9_8=atan2(l9_6,l9_7);
}
float l9_9=l9_8;
float l9_10=(3.1415927+l9_9)/6.2831855;
float l9_11=1.0-N5_progress;
l9_4*=smoothstep(l9_11,l9_11+0.003,l9_10);
l9_5*=smoothstep(l9_11-0.050000001,l9_11+0.050000001,l9_10);
float3 l9_12=N5_ringColor.xyz*(l9_4+l9_5);
float l9_13=(l9_4+l9_5)*N5_ringColor.w;
N5_fragColor=float4(l9_12,l9_13);
param_1=N5_fragColor;
fragColor_N5=param_1;
FinalColor=fragColor_N5;
...
{
float4 l9_14=gl_FragCoord;
float2 l9_15=floor(mod(l9_14.xy,float2(4.0)));
float l9_16=(mod(dot(l9_15,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_6<l9_16)
{
discard_fragment();
}
...
float4 l9_17=fast::max(param_7,float4(0.0));
float4 param_8=l9_17;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_84=param_11;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_84.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_84;
return out;
}
} // FRAGMENT SHADER
