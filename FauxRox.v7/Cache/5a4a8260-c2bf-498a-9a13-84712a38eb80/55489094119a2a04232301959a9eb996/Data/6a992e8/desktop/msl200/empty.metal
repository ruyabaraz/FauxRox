...
float4 param_4=(*sc_set0.UserUniforms).bgColor;
Output_N3=param_4;
float4 fragColor_N5=float4(0.0);
float param_6=Output_N0;
float param_7=Output_N1;
float4 param_8=Output_N2;
float4 param_9=Output_N3;
ssGlobals param_10=Globals;
ssGlobals tempGlobals=param_10;
float4 param_5=float4(0.0);
N5_progress=param_6;
N5_ringWidth=param_7;
N5_ringColor=param_8;
N5_bgColor=param_9;
...
param_5=N5_fragColor;
fragColor_N5=param_5;
...
float4 l9_19=fast::max(param_12,float4(0.0));
float4 param_13=l9_19;
if (sc_ShaderCacheConstant_tmp!=0)
{
