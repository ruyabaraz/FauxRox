...
//float Port_progress_N005 4384
//float Port_ringWidth_N005 4388
//float4 Port_ringColor_N005 4400
//float4 Port_bgColor_N005 4416
//float depthRef 4432
//}
...
float Port_ringWidth_N005;
float4 Port_ringColor_N005;
float4 Port_bgColor_N005;
float depthRef;
};
struct sc_Bone_t
{
...
float N5_ringWidth=0.0;
float4 N5_ringColor=float4(0.0);
float4 N5_bgColor=float4(0.0);
...
float param_2=(*sc_set0.UserUniforms).Port_progress_N005;
float param_3=(*sc_set0.UserUniforms).Port_ringWidth_N005;
float4 param_4=(*sc_set0.UserUniforms).Port_ringColor_N005;
float4 param_5=(*sc_set0.UserUniforms).Port_bgColor_N005;
ssGlobals param_6=Globals;
ssGlobals tempGlobals=param_6;
float4 param_1=float4(0.0);
N5_progress=param_2;
N5_ringWidth=param_3;
...
float l9_4=0.2-(N5_ringWidth*0.5);
float l9_5=0.2+(N5_ringWidth*0.5);
float l9_6=(1.0-smoothstep(l9_5,l9_5+0.0080000004,l9_3))*smoothstep(l9_4,l9_4+0.0080000004,l9_3);
float l9_7=l9_2.y;
float l9_8=l9_2.x;
float l9_9;
if (l9_7==0.0)
...
{
l9_9=atan2(l9_7,l9_8);
}
float l9_10=l9_9;
float l9_11=(3.1415927+l9_10)/6.2831855;
l9_11=mod(l9_11+0.25,1.0);
float l9_12=1.0-N5_progress;
float l9_13=smoothstep(l9_12,l9_12+0.0080000004,l9_11);
float3 l9_14=mix(N5_bgColor.xyz,N5_ringColor.xyz,float3(l9_13));
float l9_15=l9_6*fast::max(N5_bgColor.w,l9_13*N5_ringColor.w);
N5_fragColor=float4(l9_14,l9_15);
...
{
float4 l9_16=gl_FragCoord;
float2 l9_17=floor(mod(l9_16.xy,float2(4.0)));
float l9_18=(mod(dot(l9_17,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_7<l9_18)
{
discard_fragment();
}
...
float4 l9_19=fast::max(param_8,float4(0.0));
float4 param_9=l9_19;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float l9_23=l9_22;
float l9_24=l9_23;
float l9_25=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_24;
float3 l9_26=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_20.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
l9_29=float4(l9_72.x,l9_72.y,l9_72.z,l9_29.w);
float3 l9_73=mix(l9_69,l9_29.xyz,float3(l9_28.w));
l9_29=float4(l9_73.x,l9_73.y,l9_73.z,l9_29.w);
l9_29.w=1.0;
float4 l9_74=l9_29;
param_10=l9_74;
}
