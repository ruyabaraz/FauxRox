...
float param_3=Output_N0;
float param_4=(*sc_set0.UserUniforms).Port_ringWidth_N005;
float4 param_5=(*sc_set0.UserUniforms).Port_ringColor_N005;
float4 param_6=(*sc_set0.UserUniforms).Port_bgColor_N005;
ssGlobals param_7=Globals;
ssGlobals tempGlobals=param_7;
float4 param_2=float4(0.0);
N5_progress=param_3;
N5_ringWidth=param_4;
...
float4 l9_19=fast::max(param_9,float4(0.0));
float4 param_10=l9_19;
if (sc_ShaderCacheConstant_tmp!=0)
{
