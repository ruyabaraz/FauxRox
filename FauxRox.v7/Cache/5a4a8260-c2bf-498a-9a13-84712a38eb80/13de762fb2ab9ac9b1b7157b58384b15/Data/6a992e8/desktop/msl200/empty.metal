...
//float progress 4384
//float2 Port_resolution_N005 4392
...
float Output_N0=0.0;
float param_1=(*sc_set0.UserUniforms).progress;
Output_N0=param_1;
float4 fragColor_N5=float4(0.0);
float2 param_3=(*sc_set0.UserUniforms).Port_resolution_N005;
float param_4=Output_N0;
float4 param_5=(*sc_set0.UserUniforms).Port_ringColor_N005;
ssGlobals param_6=Globals;
ssGlobals tempGlobals=param_6;
float4 param_2=float4(0.0);
N5_resolution=param_3;
N5_progress=param_4;
N5_ringColor=param_5;
...
param_2=N5_fragColor;
fragColor_N5=param_2;
...
float4 l9_17=fast::max(param_8,float4(0.0));
float4 param_9=l9_17;
if (sc_ShaderCacheConstant_tmp!=0)
{
