...
float l9_11=tempGlobals.gTimeElapsed;
float l9_12=1.0-mod(l9_11/4.0,1.0);
l9_4*=smoothstep(l9_12,l9_12+0.003,l9_10);
l9_5*=smoothstep(l9_12-0.050000001,l9_12+0.050000001,l9_10);
N5_fragColor=float4(l9_4+l9_5,l9_4,l9_4,l9_4+l9_5);
...
float4 l9_16=fast::max(param_5,float4(0.0));
float4 param_6=l9_16;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_19=fast::clamp(l9_18.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_19=fast::clamp(dot(l9_18.xyz,float3(l9_18.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_19=(1.0-dot(l9_18.xyz,float3(0.33333001)))*l9_18.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_19=(1.0-fast::clamp(dot(l9_18.xyz,float3(1.0)),0.0,1.0))*l9_18.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_19=fast::clamp(dot(l9_18.xyz,float3(1.0)),0.0,1.0)*l9_18.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_19=fast::clamp(dot(l9_18.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_19=dot(l9_18.xyz,float3(0.33333001))*l9_18.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_19=1.0-fast::clamp(dot(l9_18.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_20=l9_19;
float l9_21=l9_20;
float l9_22=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_21;
float3 l9_23=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_17.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_24=float4(l9_23.x,l9_23.y,l9_23.z,l9_22);
param_7=l9_24;
}
else
{
