...
let FrameButton = (() => {
    ...
    var FrameButton = _classThis = class extends _classSuper {
        ...
        initialize(texture = null) {
            ...
            rr.hoverGradient = Gradients.backgroundHover;
