...
{
main_frag_out out={};
float2 N24_UV=float2(0.0);
float N24_BorderScale=0.0;
float N24_SliceLeft=0.0;
float N24_SliceRight=0.0;
float N24_SliceTop=0.0;
float N24_SliceBottom=0.0;
float2 N24_TextureSize=float2(0.0);
float2 N24_Result=float2(0.0);
...
Output_N13=param_6;
float Value_N38=0.0;
Value_N38=Output_N13;
float2 Value_N82=float2(0.0);
Value_N82=TextureSize_N1;
float2 Result_N24=float2(0.0);
float2 param_7=Value_N25;
float param_8=Value_N17;
float param_9=Value_N11;
float param_10=Value_N35;
float param_11=Value_N28;
float param_12=Value_N38;
float2 param_13=Value_N82;
float2 param_14=float2(0.0);
N24_UV=param_7;
N24_BorderScale=param_8;
N24_SliceLeft=param_9;
N24_SliceRight=param_10;
N24_SliceTop=param_11;
N24_SliceBottom=param_12;
N24_TextureSize=param_13;
...
float l9_6=N24_BorderScale;
float l9_7=l9_5.x;
float l9_8=l9_5.y;
float l9_9=fast::min(fast::min(l9_6,l9_7/2.0),l9_8/2.0);
float l9_10=l9_9;
float2 l9_11=N24_TextureSize;
float l9_12=l9_10;
float2 l9_13=float2((l9_11.x/l9_11.y)*l9_12,l9_12);
float2 l9_14=l9_13;
float l9_15=((N24_SliceLeft*l9_14.x)*2.0)/l9_5.x;
float l9_16=1.0-(((N24_SliceRight*l9_14.x)*2.0)/l9_5.x);
float l9_17=((N24_SliceBottom*l9_14.y)*2.0)/l9_5.y;
float l9_18=1.0-(((N24_SliceTop*l9_14.y)*2.0)/l9_5.y);
float l9_19=0.0+(((N24_UV.x-0.0)*(N24_SliceLeft-0.0))/((l9_15-0.0)+1e-06));
float l9_20=N24_SliceLeft+(((N24_UV.x-l9_15)*((1.0-N24_SliceRight)-N24_SliceLeft))/((l9_16-l9_15)+1e-06));
float l9_21=(1.0-N24_SliceRight)+(((N24_UV.x-l9_16)*(1.0-(1.0-N24_SliceRight)))/((1.0-l9_16)+1e-06));
float l9_22=0.0+(((N24_UV.y-0.0)*(N24_SliceBottom-0.0))/((l9_17-0.0)+1e-06));
float l9_23=N24_SliceBottom+(((N24_UV.y-l9_17)*((1.0-N24_SliceTop)-N24_SliceBottom))/((l9_18-l9_17)+1e-06));
float l9_24=(1.0-N24_SliceTop)+(((N24_UV.y-l9_18)*(1.0-(1.0-N24_SliceTop)))/((1.0-l9_18)+1e-06));
float l9_25;
if (N24_UV.x<l9_15)
{
l9_25=l9_19;
...
{
l9_25=(N24_UV.x<l9_16) ? l9_20 : l9_21;
}
float l9_26=l9_25;
float l9_27;
if (N24_UV.y<l9_17)
...
{
l9_27=(N24_UV.y<l9_18) ? l9_23 : l9_24;
}
float l9_28=l9_27;
N24_Result=float2(l9_26,l9_28);
param_14=N24_Result;
Result_N24=param_14;
float2 Export_N7=float2(0.0);
Export_N7=Result_N24;
...
float param_25=0.0;
bool l9_35=param_23&&(!param_21);
float l9_36=1.0;
float l9_37=param_17.x;
int l9_38=param_20.x;
if (l9_38==1)
{
l9_37=fract(l9_37);
}
...
param_17.x=l9_37;
float l9_42=param_17.y;
int l9_43=param_20.y;
if (l9_43==1)
{
l9_42=fract(l9_42);
}
...
float l9_49=param_17.x;
float l9_50=param_22.x;
float l9_51=param_22.z;
bool l9_52=l9_48;
float l9_53=l9_36;
...
float l9_58=param_17.y;
float l9_59=param_22.y;
float l9_60=param_22.w;
bool l9_61=l9_57;
float l9_62=l9_36;
...
float2 l9_65=param_17;
bool l9_66=param_18;
float3x3 l9_67=param_19;
if (l9_66)
{
...
float2 l9_68=l9_65;
param_17=l9_68;
float l9_69=param_17.x;
int l9_70=param_20.x;
bool l9_71=l9_35;
float l9_72=l9_36;
if ((l9_70==0)||(l9_70==3))
{
...
param_17.x=l9_69;
l9_36=l9_72;
float l9_80=param_17.y;
int l9_81=param_20.y;
bool l9_82=l9_35;
float l9_83=l9_36;
if ((l9_81==0)||(l9_81==3))
{
...
param_17.y=l9_80;
l9_36=l9_83;
float2 l9_91=param_17;
int l9_92=param_15;
int l9_93=param_16;
float l9_94=param_25;
float2 l9_95=l9_91;
int l9_96=l9_92;
int l9_97=l9_93;
...
float3 l9_99=l9_98;
float3 l9_100=l9_99;
float4 l9_101=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_100.xy,bias(l9_94));
float4 l9_102=l9_101;
if (param_23)
{
l9_102=mix(param_24,l9_102,float4(l9_36));
}
...
float2 l9_105=floor(mod(l9_104.xy,float2(4.0)));
float l9_106=(mod(dot(l9_105,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_26<l9_106)
{
discard_fragment();
}
...
float4 l9_107=fast::max(param_27,float4(0.0));
float4 param_28=l9_107;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_174=param_31;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_174.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_174;
return out;
}
} // FRAGMENT SHADER
