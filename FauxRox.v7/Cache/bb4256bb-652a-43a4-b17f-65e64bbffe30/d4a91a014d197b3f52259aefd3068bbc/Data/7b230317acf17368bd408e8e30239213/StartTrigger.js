...
let StartTrigger = (() => {
    ...
    var StartTrigger = _classThis = class extends _classSuper {
        ...
        bindButtons() {
            ...
            if (this.startRaceButton) {
                try {
                    var startInteractable = SIK_1.SIK.InteractionManager.getInteractableBySceneObject(this.startRaceButton);
            ...
            if (this.resetButton) {
                try {
                    var resetInteractable = SIK_1.SIK.InteractionManager.getInteractableBySceneObject(this.resetButton);
