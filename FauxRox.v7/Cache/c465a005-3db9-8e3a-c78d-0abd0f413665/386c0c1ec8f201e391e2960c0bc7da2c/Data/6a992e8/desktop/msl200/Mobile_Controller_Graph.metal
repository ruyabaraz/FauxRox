...
FinalColor=sc_OutputMotionVectorIfNeeded(param_42,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_43=FinalColor;
float4 l9_225=param_43;
if (sc_ShaderCacheConstant_tmp!=0)
{
