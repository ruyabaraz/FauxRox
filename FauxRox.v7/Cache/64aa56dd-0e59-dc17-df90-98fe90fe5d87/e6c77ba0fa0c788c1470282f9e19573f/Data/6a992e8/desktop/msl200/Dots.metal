...
int l9_135=l9_134;
l9_133=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_135]*param_2.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
{
float4 l9_140=param_2.position;
...
{
float4 l9_449=((*sc_set0.UserUniforms).sc_PrevFrameModelMatrix*(*sc_set0.UserUniforms).sc_ModelMatrixInverse)*float4(param_7,1.0);
float3 l9_450=param_7;
...
{
float4 l9_335=out.sc_FragData0;
l9_334=l9_335;
}
else
{
float4 l9_336=gl_FragCoord;
float2 l9_337=l9_336.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_342=l9_341;
int l9_343=l9_342;
float3 l9_344=float3(l9_338,0.0);
int l9_345=l9_340;
int l9_346=l9_343;
if (l9_345==1)
{
l9_344.y=((2.0*l9_344.y)+float(l9_346))-1.0;
}
float2 l9_347=l9_344.xy;
l9_339=l9_347;
}
else
{
...
int l9_358=l9_353;
float2 l9_359=l9_351;
int l9_360=sc_ScreenTextureLayout_tmp;
int l9_361=l9_358;
float l9_362=l9_352;
...
float4 l9_369=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_368.xy,bias(l9_362));
float4 l9_370=l9_369;
float4 l9_371=l9_370;
l9_334=l9_371;
}
float4 l9_372=l9_334;
float3 l9_373=l9_372.xyz;
float3 l9_374=l9_373;
float3 l9_375=l9_332.xyz;
float3 l9_376=definedBlend(l9_374,l9_375,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_333=float4(l9_376.x,l9_376.y,l9_376.z,l9_333.w);
float3 l9_377=mix(l9_373,l9_333.xyz,float3(l9_332.w));
l9_333=float4(l9_377.x,l9_377.y,l9_377.z,l9_333.w);
l9_333.w=1.0;
float4 l9_378=l9_333;
param_13=l9_378;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_379=float4(in.varScreenPos.xyz,1.0);
param_13=l9_379;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_380=gl_FragCoord;
float l9_381=fast::clamp(abs(l9_380.z),0.0,1.0);
float4 l9_382=float4(l9_381,1.0-l9_381,1.0,1.0);
param_13=l9_382;
}
else
{
float4 l9_383=param_13;
float4 l9_384=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_384=float4(mix(float3(1.0),l9_383.xyz,float3(l9_383.w)),l9_383.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_385=l9_383.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_385=fast::clamp(l9_385,0.0,1.0);
}
l9_384=float4(l9_383.xyz*l9_385,l9_385);
}
else
{
l9_384=l9_383;
