...
//ubo int UserUniforms 0:35:7488 {
//float4 sc_Time 1376
...
//float Port_Input0_N011 7396
//float2 Port_Import_N091 7400
//float2 Port_Center_N012 7408
//float Port_Input1_N013 7416
//float Port_Input1_N014 7420
//float Port_Input1_N017 7424
//float Port_Input0_N023 7428
//float Port_Input1_N057 7432
//float Port_Value0_N055 7436
//float Port_Value1_N055 7440
//float Port_Value2_N055 7444
//float Port_Default_N055 7448
//float Port_Input1_N027 7456
//float Port_Input2_N027 7460
//float Port_Input1_N030 7464
//float Port_RangeMinA_N053 7468
//float Port_Import_N003 7472
//float Port_RangeMinB_N053 7476
//float Port_RangeMaxB_N053 7480
//float Port_Input1_N054 7484
//}
...
float Port_Value0_N055;
float Port_Value1_N055;
float Port_Value2_N055;
float Port_Default_N055;
...
if (!l9_45)
{
l9_46=!(UserUniforms.vfxBatchEnable[ssInstanceID/1500]!=0);
}
else
{
l9_46=l9_45;
...
float4 l9_514=param_61;
float l9_515=param_62;
float l9_516=param_63;
float l9_517=0.99998999;
float4 l9_518=l9_514;
#if (1)
{
l9_518=floor((l9_518*255.0)+float4(0.5))/float4(255.0);
}
#endif
float l9_519=dot(l9_518,float4(1.0,0.0039215689,1.53787e-05,6.0308629e-08));
float l9_520=l9_519;
float l9_521=0.0;
float l9_522=l9_517;
float l9_523=l9_515;
...
float l9_568=l9_567;
float l9_569=l9_568;
gParticle.Quaternion.z=l9_569;
float2 param_73=float2(Scalar14,Scalar15);
float param_74=-1.0;
float param_75=1.0;
float2 l9_570=param_73;
float l9_571=param_74;
float l9_572=param_75;
float l9_573=0.99998999;
float2 l9_574=l9_570;
#if (1)
{
l9_574=floor((l9_574*255.0)+float2(0.5))/float2(255.0);
}
#endif
float l9_575=dot(l9_574,float2(1.0,0.0039215689));
float l9_576=l9_575;
float l9_577=0.0;
float l9_578=l9_573;
float l9_579=l9_571;
...
float l9_582=l9_581;
float l9_583=l9_582;
gParticle.Quaternion.w=l9_583;
float4 param_76=gParticle.Quaternion;
param_76=normalize(param_76.yzwx);
float l9_584=param_76.x*param_76.x;
float l9_585=param_76.y*param_76.y;
float l9_586=param_76.z*param_76.z;
float l9_587=param_76.x*param_76.z;
float l9_588=param_76.x*param_76.y;
float l9_589=param_76.y*param_76.z;
float l9_590=param_76.w*param_76.x;
float l9_591=param_76.w*param_76.y;
float l9_592=param_76.w*param_76.z;
float3x3 l9_593=float3x3(float3(1.0-(2.0*(l9_585+l9_586)),2.0*(l9_588+l9_592),2.0*(l9_587-l9_591)),float3(2.0*(l9_588-l9_592),1.0-(2.0*(l9_584+l9_586)),2.0*(l9_589+l9_590)),float3(2.0*(l9_587+l9_591),2.0*(l9_589-l9_590),1.0-(2.0*(l9_584+l9_585))));
gParticle.Matrix=l9_593;
...
bool l9_4=l9_3>=(1500*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[ssInstanceID/1500]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/1500];
...
param_1.Index1DPerCopy=param%1500;
param_1.Index1DPerCopyF=float(param_1.Index1DPerCopy);
param_1.StateID=(1500*((param/1500)+1))-1;
...
param_1.SpawnOffset=floor(param_1.Index1DPerCopyF/500.0)*2.0;
...
Value_N20=gParticle.Color;
float2 UVCoord_N4=float2(0.0);
UVCoord_N4=Globals.Surface_UVCoord0;
float2 Value_N91=float2(0.0);
Value_N91=fast::clamp((*sc_set0.UserUniforms).Port_Import_N091,float2(0.0),float2(10.0));
float2 Output_N11=float2(0.0);
Output_N11=float2((*sc_set0.UserUniforms).Port_Input0_N011)/(Value_N91+float2(1.234e-06));
float2 CoordsOut_N12=float2(0.0);
CoordsOut_N12=((UVCoord_N4-(*sc_set0.UserUniforms).Port_Center_N012)*Output_N11)+(*sc_set0.UserUniforms).Port_Center_N012;
float2 Output_N13=float2(0.0);
Output_N13=CoordsOut_N12*float2((*sc_set0.UserUniforms).Port_Input1_N013);
float2 Output_N14=float2(0.0);
Output_N14=Output_N13-float2((*sc_set0.UserUniforms).Port_Input1_N014);
float Output_N79=0.0;
Output_N79=Output_N14.x;
float Output_N16=0.0;
Output_N16=Output_N14.y;
float Output_N17=0.0;
Output_N17=Output_N16*(*sc_set0.UserUniforms).Port_Input1_N017;
float Output_N18=0.0;
Output_N18=atan2(Output_N17,Output_N79);
float Output_N45=0.0;
Output_N45=3.1415927;
float Output_N23=0.0;
Output_N23=(*sc_set0.UserUniforms).Port_Input0_N023*Output_N45;
float Result_N55=0.0;
float param_2=0.0;
float param_3=(*sc_set0.UserUniforms).Port_Value0_N055;
float param_4=(*sc_set0.UserUniforms).Port_Value1_N055;
float param_5=(*sc_set0.UserUniforms).Port_Value2_N055;
float param_6=(*sc_set0.UserUniforms).Port_Default_N055;
float l9_24=0.0;
l9_24=gParticle.Index1DPerCopyF;
float l9_25=0.0;
l9_25=mod(l9_24,(*sc_set0.UserUniforms).Port_Input1_N057);
param_2=l9_25;
param_2=floor(param_2);
float param_7;
if (param_2==0.0)
{
param_7=param_3;
...
Result_N55=param_7;
float Value_N24=0.0;
Value_N24=Result_N55;
float Output_N26=0.0;
Output_N26=floor(Value_N24);
float Output_N27=0.0;
Output_N27=fast::clamp(Output_N26,(*sc_set0.UserUniforms).Port_Input1_N027,(*sc_set0.UserUniforms).Port_Input2_N027);
float Output_N28=0.0;
Output_N28=Output_N23/(Output_N27+1.234e-06);
float Output_N29=0.0;
Output_N29=Output_N18/(Output_N28+1.234e-06);
float Output_N30=0.0;
Output_N30=Output_N29+(*sc_set0.UserUniforms).Port_Input1_N030;
float Output_N31=0.0;
Output_N31=floor(Output_N30);
float Output_N46=0.0;
Output_N46=Output_N31*Output_N28;
float Output_N49=0.0;
Output_N49=Output_N46-Output_N18;
float Output_N50=0.0;
Output_N50=cos(Output_N49);
float Output_N51=0.0;
Output_N51=length(Output_N14);
float Output_N52=0.0;
Output_N52=Output_N50*Output_N51;
float Output_N74=0.0;
Output_N74=1.0-Output_N52;
float Value_N3=0.0;
Value_N3=fast::clamp((*sc_set0.UserUniforms).Port_Import_N003,0.0,1.0);
float ValueOut_N53=0.0;
ValueOut_N53=(((Output_N74-(*sc_set0.UserUniforms).Port_RangeMinA_N053)/((Value_N3-(*sc_set0.UserUniforms).Port_RangeMinA_N053)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N053-(*sc_set0.UserUniforms).Port_RangeMinB_N053))+(*sc_set0.UserUniforms).Port_RangeMinB_N053;
float Export_N78=0.0;
Export_N78=ValueOut_N53;
float Output_N54=0.0;
Output_N54=float(Export_N78<(*sc_set0.UserUniforms).Port_Input1_N054);
float4 Output_N1=float4(0.0);
float4 param_8=Value_N20;
...
Output_N1=param_10;
float4 param_11=Output_N1;
Output_Color0=param_11;
float4 param_12=Output_Color0;
...
int l9_52=l9_47;
float2 l9_53=l9_45;
int l9_54=sc_ScreenTextureLayout_tmp;
int l9_55=l9_52;
float l9_56=l9_46;
float2 l9_57=l9_53;
int l9_58=l9_54;
...
float3 l9_61=l9_60;
float3 l9_62=l9_61;
float4 l9_63=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_62.xy,bias(l9_56));
float4 l9_64=l9_63;
float4 l9_65=l9_64;
l9_28=l9_65;
}
float4 l9_66=l9_28;
float3 l9_67=l9_66.xyz;
float3 l9_68=l9_67;
float3 l9_69=l9_26.xyz;
float3 l9_70=definedBlend(l9_68,l9_69,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_27=float4(l9_70.x,l9_70.y,l9_70.z,l9_27.w);
float3 l9_71=mix(l9_67,l9_27.xyz,float3(l9_26.w));
l9_27=float4(l9_71.x,l9_71.y,l9_71.z,l9_27.w);
l9_27.w=1.0;
float4 l9_72=l9_27;
param_12=l9_72;
}
...
{
float4 l9_73=float4(in.varScreenPos.xyz,1.0);
param_12=l9_73;
}
else
{
...
{
float4 l9_74=gl_FragCoord;
float l9_75=fast::clamp(abs(l9_74.z),0.0,1.0);
float4 l9_76=float4(l9_75,1.0-l9_75,1.0,1.0);
param_12=l9_76;
}
else
{
...
{
l9_78=float4(mix(float3(1.0),l9_77.xyz,float3(l9_77.w)),l9_77.w);
}
else
{
...
{
l9_79=fast::clamp(l9_79,0.0,1.0);
}
l9_78=float4(l9_77.xyz*l9_79,l9_79);
}
else
{
l9_78=l9_77;
