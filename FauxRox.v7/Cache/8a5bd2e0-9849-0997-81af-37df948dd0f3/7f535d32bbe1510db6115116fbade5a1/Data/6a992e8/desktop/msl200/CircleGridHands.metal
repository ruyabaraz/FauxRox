...
FinalColor=sc_OutputMotionVectorIfNeeded(param_74,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_75=FinalColor;
float4 l9_304=param_75;
if (sc_ShaderCacheConstant_tmp!=0)
{
