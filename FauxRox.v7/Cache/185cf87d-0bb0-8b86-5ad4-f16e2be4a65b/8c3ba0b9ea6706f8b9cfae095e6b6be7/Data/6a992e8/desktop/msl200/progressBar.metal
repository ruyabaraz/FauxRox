...
//sampler sampler deepMapSmpSC 0:24
...
//texture texture2D deepMap 0:5:0:24
...
//float4 barColor 4384
//float3x3 baseTexTransform 4448
//float4 baseTexUvMinMax 4496
//float4 baseTexBorderColor 4512
//float3x3 deepMapTransform 4576
//float4 deepMapUvMinMax 4624
//float4 deepMapBorderColor 4640
//float currentPosition 4656
//float globalOpacity 4660
//float2 Port_Scale_N008 4664
//float2 Port_Center_N008 4672
//float Port_RangeMinA_N012 4680
//float Port_RangeMaxA_N012 4684
//float Port_RangeMinB_N012 4688
//float Port_RangeMaxB_N012 4692
//float Port_Value2_N010 4696
//float depthRef 4700
//}
...
//spec_const bool deepMapHasSwappedViews 42 0
...
constant bool SC_USE_CLAMP_TO_BORDER_deepMap [[function_constant(32)]];
constant bool SC_USE_CLAMP_TO_BORDER_deepMap_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_deepMap) ? SC_USE_CLAMP_TO_BORDER_deepMap : false;
...
constant bool SC_USE_UV_MIN_MAX_deepMap [[function_constant(35)]];
constant bool SC_USE_UV_MIN_MAX_deepMap_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_deepMap) ? SC_USE_UV_MIN_MAX_deepMap : false;
...
constant bool SC_USE_UV_TRANSFORM_deepMap [[function_constant(38)]];
constant bool SC_USE_UV_TRANSFORM_deepMap_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_deepMap) ? SC_USE_UV_TRANSFORM_deepMap : false;
...
constant bool deepMapHasSwappedViews [[function_constant(42)]];
constant bool deepMapHasSwappedViews_tmp = is_function_constant_defined(deepMapHasSwappedViews) ? deepMapHasSwappedViews : false;
...
constant int SC_SOFTWARE_WRAP_MODE_U_deepMap [[function_constant(76)]];
constant int SC_SOFTWARE_WRAP_MODE_U_deepMap_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_deepMap) ? SC_SOFTWARE_WRAP_MODE_U_deepMap : -1;
constant int SC_SOFTWARE_WRAP_MODE_U_intensityTexture [[function_constant(77)]];
constant int SC_SOFTWARE_WRAP_MODE_U_intensityTexture_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_intensityTexture) ? SC_SOFTWARE_WRAP_MODE_U_intensityTexture : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_baseTex [[function_constant(78)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_deepMap [[function_constant(79)]];
constant int SC_SOFTWARE_WRAP_MODE_V_deepMap_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_deepMap) ? SC_SOFTWARE_WRAP_MODE_V_deepMap : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_intensityTexture [[function_constant(80)]];
constant int SC_SOFTWARE_WRAP_MODE_V_intensityTexture_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_intensityTexture) ? SC_SOFTWARE_WRAP_MODE_V_intensityTexture : -1;
constant int baseTexLayout [[function_constant(81)]];
constant int baseTexLayout_tmp = is_function_constant_defined(baseTexLayout) ? baseTexLayout : 0;
constant int deepMapLayout [[function_constant(82)]];
constant int deepMapLayout_tmp = is_function_constant_defined(deepMapLayout) ? deepMapLayout : 0;
...
float4 deepMapDims;
float4 deepMapView;
float3x3 deepMapTransform;
float4 deepMapUvMinMax;
float4 deepMapBorderColor;
float currentPosition;
float globalOpacity;
float2 Port_Scale_N008;
float2 Port_Center_N008;
float Port_RangeMinA_N012;
float Port_RangeMaxA_N012;
float Port_RangeMinB_N012;
float Port_RangeMaxB_N012;
...
float4 param_1=(*sc_set0.UserUniforms).barColor;
Output_N1=param_1;
...
Output_N0=l9_75;
float Output_N3=0.0;
Output_N3=Output_N0.y;
float2 UVCoord_N6=float2(0.0);
UVCoord_N6=Globals.Surface_UVCoord0;
float2 CoordsOut_N8=float2(0.0);
CoordsOut_N8=((UVCoord_N6-(*sc_set0.UserUniforms).Port_Center_N008)*(*sc_set0.UserUniforms).Port_Scale_N008)+(*sc_set0.UserUniforms).Port_Center_N008;
float Output_N11=0.0;
float param_13=(*sc_set0.UserUniforms).currentPosition;
Output_N11=param_13;
float ValueOut_N12=0.0;
ValueOut_N12=(((Output_N11-(*sc_set0.UserUniforms).Port_RangeMinA_N012)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N012-(*sc_set0.UserUniforms).Port_RangeMinA_N012)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N012-(*sc_set0.UserUniforms).Port_RangeMinB_N012))+(*sc_set0.UserUniforms).Port_RangeMinB_N012;
float2 Value_N10=float2(0.0);
Value_N10.x=ValueOut_N12;
Value_N10.y=(*sc_set0.UserUniforms).Port_Value2_N010;
float2 CoordsOut_N9=float2(0.0);
CoordsOut_N9=CoordsOut_N8+Value_N10;
float4 Output_N5=float4(0.0);
int l9_76;
if ((int(deepMapHasSwappedViews_tmp)!=0))
{
int l9_77=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_81=l9_76;
int param_14=deepMapLayout_tmp;
int param_15=l9_81;
float2 param_16=CoordsOut_N9;
bool param_17=(int(SC_USE_UV_TRANSFORM_deepMap_tmp)!=0);
float3x3 param_18=(*sc_set0.UserUniforms).deepMapTransform;
int2 param_19=int2(SC_SOFTWARE_WRAP_MODE_U_deepMap_tmp,SC_SOFTWARE_WRAP_MODE_V_deepMap_tmp);
bool param_20=(int(SC_USE_UV_MIN_MAX_deepMap_tmp)!=0);
float4 param_21=(*sc_set0.UserUniforms).deepMapUvMinMax;
bool param_22=(int(SC_USE_CLAMP_TO_BORDER_deepMap_tmp)!=0);
float4 param_23=(*sc_set0.UserUniforms).deepMapBorderColor;
float param_24=0.0;
...
float4 l9_148=sc_set0.deepMap.sample(sc_set0.deepMapSmpSC,l9_147.xy,bias(l9_141));
...
Output_N14=Output_N5.x;
float Output_N15=0.0;
Output_N15=Output_N3-Output_N14;
float4 Value_N2=float4(0.0);
Value_N2=float4(Output_N1.xyz.x,Output_N1.xyz.y,Output_N1.xyz.z,Value_N2.w);
Value_N2.w=Output_N15;
float Output_N17=0.0;
Output_N17=Value_N2.w;
float Output_N20=0.0;
float param_25=(*sc_set0.UserUniforms).globalOpacity;
Output_N20=param_25;
float Output_N21=0.0;
Output_N21=Output_N17*Output_N20;
float4 Value_N16=float4(0.0);
Value_N16=float4(Value_N2.xyz.x,Value_N2.xyz.y,Value_N2.xyz.z,Value_N16.w);
Value_N16.w=Output_N21;
