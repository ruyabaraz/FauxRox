...
export class HandZoneDetector extends BaseScriptComponent {
  ...
  private _targetObject: SceneObject = null;  // External target object (e.g., sphere for squat press)
  private _targetObjectRadius: number = 0;    // Radius of target object (from scale)
  ...
  private processAirSkiErg(hands: HandPositions, camPos: vec3): void {
    var leftY = hands.leftY - camPos.y;
    var rightY = hands.rightY - camPos.y;
    var avgY = (leftY + rightY) / 2;
  ...
  private processHorizontalMotion(hands: HandPositions, camPos: vec3): void {
    ...
    if (this._motionType === MotionType.BACKWARD_PULL) {
